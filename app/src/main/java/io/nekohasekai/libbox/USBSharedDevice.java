...
public final class USBSharedDevice implements Seq.Proxy {
    ...
    public final native void setState(int v);
    ...
    public boolean equals(Object o) {
        if (o != null && (o instanceof USBSharedDevice)) {
            USBSharedDevice that = (USBSharedDevice) o;
            ...
            int thisState = getState();
            int thatState = that.getState();
    ...
    public String toString() {
        ...
        b.append("USBSharedDevice").append("{");
